...
//                {
//                    Dictionary<uint, PokerTable> ToRem = new Dictionary<uint, PokerTable>();
//                    foreach (PokerTable T in PokerTables.Values)
//                    {
//                        if (Owner.Map.ID == T.Map)
//                            if (Kernel.GetDistance(T.X, T.Y, Owner.Entity.X, Owner.Entity.Y) > Constants.nScreenDistance)
//                                ToRem.Add(T.Id, T);
//                    }
